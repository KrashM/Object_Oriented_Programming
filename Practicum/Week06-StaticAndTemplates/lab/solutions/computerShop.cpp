...
ComputerShop::ComputerShop(const std::string& name) 
    : name(name) {}

ComputerShop& ComputerShop::getInstance(const std::string& name)
{
    static ComputerShop object(name);
...
List<Computer> ComputerShop::filter(filterFunction func) const
{
