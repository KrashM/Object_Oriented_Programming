<h1>Предефиниране на оператори. Приятелски класове и функции. Mutable полета. Класове с масиви от указатели към обекти.</h1>
...
**Задача 1:** В класът String да се добавят необходимите оператори. За референция можем да ползваме [това](https://cplusplus.com/reference/string/string/).

**Задача 2:** Да се реализира класът Vector. За референция можем да ползваме [това](https://cplusplus.com/reference/vector/vector/).
