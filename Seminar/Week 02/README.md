<h1>Потоци и Файлове. Текстови файлове.</h1>
...
<h5>Примери за запазване на стуктури във файл</h5>
...
<h5>Пример за запазване на масив от стуктури във файл</h5>
